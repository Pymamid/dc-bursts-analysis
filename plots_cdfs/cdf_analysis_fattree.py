...
# Example usage: 
# # cd /home/pragna/work/chris_ns3 && python3 cdf_analysis_fattree.py --canonical_dir ns-3-dev-git/scratch/traces/canonical-fattree --bg_incast_dir ns-3-dev-git/scratch/traces/bg-incast-fattree --burst_aware_dir ns-3-dev-git/scratch/traces/burst-aware-fattree --output_file fattree_cdfs.png
