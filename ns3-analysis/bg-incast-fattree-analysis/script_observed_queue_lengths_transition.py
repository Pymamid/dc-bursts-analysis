...
agg_bytes_file_path = os.path.join(cur_dir, '../../../../chris_ns3/ns-3-dev-git/scratch/traces/bg-incast-fattree/logs/aggregator_bytes_received.log')
...
with open(agg_bytes_file_path, 'r') as file:
    ...
    for line in lines:
        ...
        data_list.append({"TimestampMs": timestamp_ms, "BytesReceived": bytes_received})

data = pd.DataFrame(data_list, columns=["TimestampMs", "BytesReceived"])
